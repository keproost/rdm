...
module.exports = (gulp, callback) => {
  ...
  const scssWatchCustomTask = function () {
    return gulp.watch(config.assets+'/**/*.scss', gulp.parallel(scssCoreTask, scssMainTask, scssPagesTask, scssPluginTask, scssStyleTask, scssThemesTask));
  }
  ...
  return {
    ...
    rtl: scssRtlTask,
    watch: scssWatchTask,
    watchCustomAssets: scssWatchCustomTask
  }
}
